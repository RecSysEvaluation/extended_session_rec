...
init_seed(2000)
class TAGNN:
    def __init__(self, epoch = 1 ,  lr = 0.001, batch_size = 300, embedding_size = 100, l2 = 0.0004):
        self.lr = lr
    ...
    def fit(self, train, test):
        ...
        lenn  = len(features1)
        model = trans_to_cuda(SessionGraph(self.lr, self.batch_size, self.hidden_size, item_no, self.l2))
    ...
    def predict_next(self, sid, prev_iid, items_to_predict, timestamp):
       ...
       test_data = Data(temp_list, shuffle=False)
       self.model.eval()
