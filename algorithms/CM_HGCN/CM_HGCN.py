...
class CM_HGCN:
    ...
    def fit(self, train, test):
        ...
        train_data = Data(train_data, self.category)
        
        test_data = (features1, targets1)
        test_data = Data(test_data, self.category)
        
        
        model = trans_to_cuda(CombineGraph(self.num_node + self.n_category-1, self.n_category, self.category, self.lr, self.batch_size, self.l2, self.embedding))
        Mrr20List = []
        counter = 0
        # start learning...... 
