...
import torch
import numpy as np
from algorithms.GNRRW.aggregator import *


class NeighRoutingGnnCls2Scores(nn.Module):
    def __init__(self, hidden_size, routing_iter, n_factors, hop, session_length, n_items, adj_items, weight_items, prob, device):
