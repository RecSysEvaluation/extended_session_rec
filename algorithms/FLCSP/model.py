...
class MutiHeadAttn(nn.Module):
    def __init__(self, num_words, anchor_num, N, topic_mat, dropout, hid_size, lr, l2, lr_dc_cate, device='cpu'):
...
class GRUTCN(nn.Module):
    def __init__(self, num_words, item_emb_size, hidden_size, num_channels,
                 kernel_size=3, dropout=0.3, emb_dropout=0.1, lr = 0.001, lr_dc = [10, 15], l2 = 1e-5, device='cpu'):
